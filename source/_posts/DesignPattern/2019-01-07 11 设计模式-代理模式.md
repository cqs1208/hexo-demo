...
![代理模式示例](/images/DesignPattern/DesignPattern_proxy.png)
...
**动态代理有以下特点:**
1.代理对象,不需要实现接口
2.代理对象的生成,是利用JDK的API,动态的在内存中构建代理对象(需要我们指定创建代理对象/目标对象实现的接		口的类型)
...
[参考链接](http://www.cnblogs.com/cenyu/p/6289209.html)
