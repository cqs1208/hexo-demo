---
layout: post
title: 11 AbstractQueuedSynchronizer
tags:
- JUC
categories: JUC
description: 并发编程
...
##### 4.1.5 shouldParkAfterFailedAcquire(Node, Node)
...
##### 4.3.2 setHeadAndPropagate(Node, int)
